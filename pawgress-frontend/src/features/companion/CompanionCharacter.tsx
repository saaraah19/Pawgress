...
import { COMPANION_EXPRESSION_ASSETS, COMPANION_TIMING, type CompanionExpressionKey } from "./companionConfig";
 ...
 * placeholder paw glyph. Replaces CompanionIndicator entirely.
 *
...
export const CompanionCharacter = forwardRef<CompanionCharacterHandle, CompanionCharacterProps>(
  function CompanionCharacter({ size = 30 }, ref) {
    ...
    return (
      <span className="companion-character" style={{ width: size, height: size }} title="Your companion">
        <img
